...
public class Aims {
    ...
    public static void main(String[] args) {
        ...
        DigitalVideoDisc dvd1 = new DigitalVideoDisc("Dragon Ball", "Animation", "Misaki", 87, 19.95f);
        cart.addMedia(dvd1);

        DigitalVideoDisc dvd2 = new DigitalVideoDisc("Spider man", "Science Fiction", "Sam Raimi", 87, 24.95f);
        cart.addMedia(dvd2);
        
        DigitalVideoDisc dvd3 = new DigitalVideoDisc("The soul", "Animation", "Andrew Stanton", 100, 15.0f);
        cart.addMedia(dvd3);
